...
BEGIN
  ...
  SET FOREIGN_KEY_CHECKS=1;
    ...
    */
    ...
    INSERT INTO question(id_question, enonce, id_qcm, est_correcte) VALUES
    ...
    (6, 'Quel est ma question ? (Plusieurs choix possibles)', 3, 1),
    (7, 'Quelle est la bonne longueur pour sauter jusqu''à là ?', 3, 0),
    (8, 'Combien de pommes pour une tarte ?', 4, 1),
    (9, 'Quel est la commande permettant d''ajouter une valeur en base de donnée ?', 4, 1),
    (10, 'Quelles sont les congruances pour 4 ?', 4, 0),
    (11, 'Quel est la couleur de la chêvre ?', 4, 1);
