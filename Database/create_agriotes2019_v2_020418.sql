...
CREATE TABLE IF NOT EXISTS `agriotes2019`.`question` (
  ...
  INDEX `fk_question_questionnaire1_idx` (`id_qcm` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `agriotes2019`.`reponse_donnee` (
  ...
  INDEX `fk_question_has_passage_questionnaire_passage_questionnaire_idx` (`id_passage_qcm` ASC) VISIBLE,
