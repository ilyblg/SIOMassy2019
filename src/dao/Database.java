...
/**
 * Représente la base de données. Fournit une connexion �  cette base (via
...
public class Database {
    ...
    protected static final String USER = "agriotes2019user@localhost";
    ...
    // La chaine de connexion diffère d'un SGBD �  l'autre.
    ...
    /**
     * Fournit une connexion �  la base de données. Ne fait pas appel �  un pool
    ...
    /**
     * Réinitialise la base �  la date passée en paramètre. Si ce paramètre vaut
